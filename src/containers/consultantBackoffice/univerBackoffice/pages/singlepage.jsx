...
import userpic from "../../../../assets/icon/userpic1.svg";
...
function Singlepage() {
  ...
  const kerak = () => {
    Axios.get(`/applicant/${params.id}/`).then((res) => {
        ...
        <div className="single_down" style={{ marginRight: "150px" }}>
          ...
          <div className="single_info">
            ...
            <div className="info_1">
              ...
              <div>
                <h1>
                  {userInfo.email ? userInfo.email : 'нет email'}
                </h1>
              </div>
            </div>
            <div className="info_1">
            ...
            {/* <div className="info_1">
              ...
              <div>
                <h1>
                  {userInfo.phone_number ? userInfo.phone_number : 'нет телефон номер '}
                </h1>
              </div>
            </div> */}
            <div className="info_1">
            ...
            >
              ...
              >
                ...
                <a
                  href={userInfo?.passport_translate}
                  className="form_doc"
                  target="_blank"
                >
                  <img src={pdf} alt="" />
                  <p> Перевод паспорта</p>
                  <img src={down_doc} alt="" />
                </a>
                : <p style={{color: 'red'}}>перевод недоступен</p>}
              </div>
            </div>
            <div
              className="info_1 info_a"
            ...
            >
              <div style={{ marginRight: "150px" }}>
                <h1>Перевод Дипломa/Аттестатa</h1>
              </div>
              <div>
                {userInfo?.diploma_translate ?
                  <a
                    href={userInfo?.diploma_translate}
                    className="form_doc"
                    target="_blank"
                  >
                    <img src={pdf} alt="" />
                    <p>Перевод Дипломa/Аттестатa </p>
                    <img src={down_doc} alt="" />
                  </a>
                  : <p style={{color: 'red'}}>перевод недоступен</p>}
              </div>
