  ...
  const filterApplicants = async () => {
    ...
    try {
      const res = await Axios.get(
        `/applicant/list/?date-from=${startDate ? startDate.toLocaleDateString() : ""
        }&date-to=${endDate ? endDate.toLocaleDateString() : ""
        }&payment-status=${filter.filter}&search=${searchName ? searchName : ""
        ...
        <div className="asos" id="top">
          ...
          <div className="SidebarUniverstitet">
            ...
            <div className="univerList talabalar" id="scroll_bar">
                        ...
                        .map((item, i) => {
                          ...
                          return (
                            <tr key={id} className="accTickTableTr">
                              ...
                              <td>{contract_created_at.slice(0, contract_created_at.indexOf('T'))}</td>
                              <td>{amount}</td>
                              <td>{phone_number}</td>
                              ...
                              <td>
                                ...
                                {invoice_confirmed ?
                                  ...
                                  : invoice_confirmed === null || invoice_confirmed === false && invoice === null ? '' :
                                    <ConfirmedButton >Платеж не потвержден</ConfirmedButton>
                                }
                              </td>
                            </tr>
                          );
              ...
              <TablePagination
                rowsPerPageOptions={[10, 20, 30, 40,500]}
                component="table"
                count={count}
            ...
            >
              ...
              >
                ...
                <div className="FilterUniver">
                  ...
                  <button onClick={filterApplicants}>{t("p246")}</button>
                </div>
                {/* end FilterUniver */}
              </div>
            </div>
