...
const Sidebar = (props) => {
    ...
    return (
        <>
            <div
                className={
                    burger ? "switch_asos toggle_burger" : "switch_asos"
                }
            >
                        ...
                        <div className="sidebar">
                            ...
                            {(selector.role == "branch_director" && <span></span> ||
                                <div className={menu ? "div_active div_a" : "div_a"}>
                                    <div
                                        className={
                                            menu ? "link_active bugalter" : "bugalter"
                                        }
                                    >
                            ...
                            {(selector.role == "branch_director" && <NavLink onClick={handleclose} to="/home/manager">
                                {t("sidebar10")}
                            </NavLink> || <NavLink onClick={handleclose} to="/home/manager">
                                    {t("sidebar11")}
                                </NavLink>)}
                            {(selector.role == "branch_director" && <span></span> ||
                            ...
                            {(selector.role == "branch_director" && <NavLink onClick={handleclose} to="/home/agents">
                                {t("sidebar14")}
                            </NavLink> || <NavLink onClick={handleclose} to="/home/agents">
                                    {t("sidebar15")}
                                </NavLink>)}
