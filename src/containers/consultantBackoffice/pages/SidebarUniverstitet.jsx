...
const SidebarUniverstitet = () => {
  ...
  const handlePageChange = async (e, newPage) => {
    ...
    setLoading(true)
    try {
      const res = await Axios.get(`/university/?limit=${rowsPerPage}&offset=${newPage * rowsPerPage}`);
          ...
          <>
            ...
            <div className="SidebarUniverstitet">
              {selector?.role === "branch_director" ? (
                ...
                <button onClick={handleOpen}>{t("unver1")}</button>
              )}
