...
function Oplata3() {
  ...
  const onButtonClick = () => {
    setState({
      textToCopy: [
        "Получатель: “Asia Consult Edugately ( Mas'uliyati CHeklangan Jamiyat)”",
        "ИНН:309377196",
        "Х/Р: 2020 8000 3055 0479 1001",
        "Банк получателя: АТИБ 'Ипотека банк' Шайхонтохур филиали",
        "МФО банка получателя: 00425",
      ],
    });
    handleClick({
      vertical: "top",
      ...
      <div className="singup_asos container">
        ...
        <div className="main_singup">
              ...
              <div className="oplata_switch">
                <div className="bank_card">
                  ...
                  <div className="bank_list">
                    <h5>{t("p499")}</h5>
                    <h5>Asia Consult Edugately ( Mas'uliyati CHeklangan Jamiyat)</h5>
                  </div>
                  <div className="bank_list">
                    <h5> {t("p498")}</h5>
                    <h5>309377196</h5>
                  ...
                  <div className="bank_list">
                    <h5>Х/Р: </h5>
                    <h5>2020 8000 3055 0479 1001</h5>
                  </div>
                  <div className="bank_list">
                    <h5> {t("p601")}</h5>
                    <h5>АТИБ "Ипотека банк" Шайхонтохур филиали</h5>
                  </div>
                  <div className="bank_list">
                    <h5 onChange={state.textToCopy}> {t("p602")} </h5>
                    <h5>00425</h5>
                  </div>
          ...
          <div className="bank_btn">
            ...
            <button
              style={data.bankTransiction ? {} : { cursor: "not-allowed" }}
              onClick={(e) => sendInovoice(e)}
              className="a_send"
            >
              {t("p249")}
            </button>
        ...
        >
          <Fade in={state.modal1}>
            <div className="alert_tasdiq">
              <img src={tasdiq} alt="" />
              <p> {t("p608")}</p>
              <button onClick={handleclose1}> {t("p312")}</button>
            </div>
          </Fade>
        </Modal>
        <Modal
