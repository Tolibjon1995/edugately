...
const ChangeUniver = () => {
  ...
  return (
    <React.Fragment>
      <ManegerSidebar />
      <Table>
        <div style={{ float: "none" }} className="right-doc">
                    ...
                    <UniverChangeContainer>
                      ...
                      <div className="mainContainer">
                        <div className="inputContainer">
                          <label htmlFor="univer"> {t("p374")}</label>
                          <select
                            name="univer"
                        ...
                        >
                          ...
                          <div>
                            <label htmlFor="univer"> {t("p234")}</label>
                            <select
                              name="edu"
                              ...
                              <option selected value="">
                                {(userData[0]?.major?.education_type == "full_time" &&
                                    ...
                                    (userData[0]?.major?.education_type === "distance" &&
                                      t("p253")) ||
                                    (userData[0]?.major?.education_type === "night_time" &&
                                      t("p321"))}
                              </option>
                        ...
                        <div className="inputContainer">
                          <label htmlFor="univer"> {t("p241")} </label>
                          <select
                            name="faculty"
                        ...
                        <div className="inputContainer">
                          <label htmlFor="univer"> {t("part54")}</label>
                          <select
                            name="major"
