...
import BranchManagerAnalitika from "../containers/Maneger/pages/BranchMangeranalitika";
import BranchManagerGlavny from "../containers/Maneger/pages/BranchManagerGlavny";
import PhoneCall from "../containers/Maneger/pages/PhoneCall";
import Shartnoma from "../containers/Maneger/pages/Shartnoma";
import SInglePageById from "../containers/web/pages/SInglePageById";
import SignUpComplete from "../containers/web/pages/singup/SignUpComplete";
import Otkaz from "../containers/Maneger/pages/Otkaz";
import Biz from "../containers/web/pages/Biz";
import Tolangan from "../containers/Accountant/Pages/Tolangan";
import Tabrik from "../containers/consultantBackoffice/univerBackoffice/pages/Tabrik";
...
const routes = {
  ...
  public: [
    ...
    {
      key: "university",
      path: "/university-major/:id",
      component: SInglePageById,
      exact: true,
    },
    {
      key: "clientAdd",
  ...
  maneger: [
    ...
    },
    {
      key: "superSidebar",
      path: "/super-ziyo",
      component: ZiyoSupper,
      exact: true,
    },
    {
      key: "superSidebar",
      path: "/bind-unversite",
      component: UnverBiriktirish,
      exact: true,
    },
    ...
    {
      key: "managerTable",
      path: "/branchAgentGlavny",
      component: BranchManagerGlavny,
      exact: true,
    },
    {
      key: "managerTable",
      path: "/branchManagerAnalitika",
      component: BranchManagerAnalitika,
      exact: true,
    },
  ],
};
